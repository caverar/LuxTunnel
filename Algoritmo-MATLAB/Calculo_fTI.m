...
clc
    ...
    Lanes=input('Número de carriles: 2 ');
    Nc=Lanes*3;
    Rot=input('¿Rotacion de 90 grados? Si(1)/No(0): 0 ');
    Fm=0.5;
    A=23; %edad del conductor
    Ohang=input('Desplazamiento de Luminarias: T= 0 ');
    Distri=input('Distribucion: Single-side-Left(0)/Single-side-Right(1)/Double-side(2)/Double-side-staggered(3) : 0 ')
