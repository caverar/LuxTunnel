...
clc
    ...
    H=input('Altura luminarias: H=10');
    S=input('Distancia entre luminarias: S=40'); 
    Wl=input('Ancho del camino < 30m: W=25'); 
    Lanes=input('Numero de carriles: 2 ');
    Nc=Lanes*3;
    Rot=input('�Rotacion de 90 grados? Si(1)/No(0): 0 ');
    Fm=0.5;

%Nlum=input('Numero de luminarias: ');
...
for nl=nl:Nlum
    ...
    for i=i:Nc
        ...
        for j=j:N
            ...
            c = IES(yfL(i,j,nl),CfL(i,j,nl));
            disp("C: " + CfL(i,j,nl) + ", Y: " + yfL(i,j,nl))
            disp("eq3: " + eq3(i,j) + ", eq4: " + eq4(i,j)+ ", IL: " + IL(i,j,nl)+ ", c: " + c)
            value = j;
        end
    end 
end
    ...
    for nl=nl:Nlum
        ...
        for i=i:Nc
            ...
            for j=j:N
                ...
                disp("i: " + no + ", j: " + nl + ", k: " + j + ", l: " +  i + ", eq3: " + eq3(i,j) + ", eq4: " + eq4(i,j))
            end
        end 
    end
end
